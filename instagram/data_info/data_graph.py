...
def main():
    ...
    json_file_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'instagram_comments_by_keyword.json')
    ...
    print(f"Instagram 平台總留言數量: {total_comments}")
    print("各藝人相關留言量:")
    ...
    plt.title('Instagram 各藝人相關留言數量統計', fontproperties=font_prop, fontsize=24)
    ...
    # Save the plot
    output_path = os.path.join(os.path.dirname(__file__), 'ig_comments_stats.png')
