...
def main():
    ...
    json_file_path = os.path.join(os.path.dirname(__file__), 'threads_sentiment_by_keyword.json')
    ...
    ax.set_title('Threads 各藝人情感分析比例', fontproperties=font_prop, fontsize=24)
    ...
    # Save the plot
    output_path = os.path.join(os.path.dirname(__file__), 'threads_sentiment_stats.png')
